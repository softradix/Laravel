...
<section id="My-Property">
  <div class="container box-row mt-5 pb-4">
    <div class="row">
      <div class="col-lg-12">
        <h4 class="font-weight-bold text-center pt-5">Preview Your Shelter</h4>
      </div>
    </div>
          ...
          <div class="inner">
            <div class="row pl-3">
              <div class="col-lg-12 mt-4">
                <p class=" font-weight-bold">Shelter Type</p>
              </div>
            </div>
            <div class="row pl-3">
              <div class="col-lg-12">
            ...
            <div class="row pl-3 {{isset($shelter->property_feature) && $shelter->property_feature == '4' && isset($shelter->other_property_feature)? '' : 'd-none'}} hf hf-other mt-4">
              <div class="col-lg-4">
                <div class="form-group">
                  <label for="other_property_feature" class="age-title">Mention other shelter feature here</label>
            ...
            <div class="row pl-3">
              <div class="col-lg-12 mt-5">
                <p class=" font-weight-bold mb-0">Looking For</p>
              </div>
            </div>
            <div class="row pl-3">
            ...
            <div class="row pl-3 hf">
              <div class="col-lg-12 mt-3">
                <p class=" font-weight-bold mb-0">Flat Layout</p>
              </div>
            </div>
            <div class="row pl-3">
              <div class="col-lg-4 mt-4 hf">
                <div class="stv-radio-buttons-wrapper">
                  <input type="radio" class="stv-radio-button" name="flat_type" value="1" id="button1bk"
              ...
              <div class="col-lg-4 mt-3 mt-lg-0 hf">
                <div class="form-group">
                  <label for="flat_size" class="age-title">Size of flat</label><label class="year-title">Sq
                    ft.</label>
            ...
            <div class="row pl-3">
              ...
              <div class="col-lg-4 mt-4 family-select">
                <p class="font-weight-bold">Preferred Guest</p>
                <div class="stv-radio-buttons-wrapper">
            ...
            <div class="row pl-3">
              ...
              <div class="col-lg-4 mt-4">
                <div class="form-group">
                  <label for="expected_rent" class="age-title">Expected Rent ( &#8377; )</label>
              ...
              <div class="col-lg-4 mt-4">
                <div class="form-group">
                  <label for="security_deposit" class="age-title">Security Deposit( &#8377; )</label>
            ...
            <div class="col-lg-12" style="padding-top:20px;">
                <div class="row" id="map_row" style="width:100%; height:300px; margin: 0 auto;" aria-hidden="true" data-lat='{{$shelter->latitude}}' data-lng='{{$shelter->longitude}}'> 
                </div>
            </div>
            ...
            <div class="row pl-3">
              <div class="col-lg-4 mt-4">
                <div class="form-group">
                  <label for="states" class="age-title">State</label>
              ...
              <div class="col-lg-4 mt-4">
                <div class="form-group">
                  <label for="city" class="age-title">City</label><br>
              ...
              <div class="col-lg-4 mt-4">
                <div class="form-group">
                  <label for="locality" class="age-title">Locality</label>
              ...
              <div class="col-lg-4 mt-4">
                <div class="form-group">
                  <label for="street" class="age-title">Street/Area</label>
              ...
              <div class="col-lg-4 mt-4">
                <div class="form-group">
                  ...
                  <input type="number" class="form-control input-cl pl-0" id="pincode" name="pincode" value="{{isset($shelter->pincode) ? $shelter->pincode : ''}}"
                    placeholder="132103" min="100000" max="999999" required onKeyPress="if(this.value.length==6) return false;">
                </div>
              </div>
            </div>
          </div>
                ...
                <ul class="chec-radio pl-0">
                  <li class="pz">
                    <label class="radio-inline">
                      ...
                      <div class="clab">
                        <div class="img-ameni {{isset($shelter->amenities) && in_array('1',$shelter->amenities) ? 'd-none' : ''}}">
                          <img src="{{URL::asset('images/icon/icon-black/cupboard.png')}}" draggable="false">
                        </div>
                        <div class="img-ameni-white {{isset($shelter->amenities) && in_array('1',$shelter->amenities) ? '' : 'd-none'}}">
                ...
                <ul class="chec-radio pl-0">
                  <li class="pz">
                    <label class="radio-inline">
                      ...
                      <div class="clab">
                        <div class="img-ameni {{isset($shelter->amenities) && in_array('2',$shelter->amenities) ? 'd-none' : ''}}">
                          <img src="{{URL::asset('images/icon/icon-black/lift.png')}}" draggable="false">
                        </div>
                        <div class="img-ameni-white {{isset($shelter->amenities) && in_array('2',$shelter->amenities) ? '' : 'd-none'}}">
                ...
                <ul class="chec-radio pl-0">
                  <li class="pz">
                    <label class="radio-inline">
                      ...
                      <div class="clab">
                        <div class="img-ameni {{isset($shelter->amenities) && in_array('3',$shelter->amenities) ? 'd-none' : ''}}">
                          <img src="{{URL::asset('images/icon/icon-black/bath.png')}}" draggable="false">
                        </div>
                        <div class="img-ameni-white {{isset($shelter->amenities) && in_array('3',$shelter->amenities) ? '' : 'd-none'}}">
                ...
                <ul class="chec-radio pl-0">
                  <li class="pz">
                    <label class="radio-inline">
                      ...
                      <div class="clab">
                        <div class="img-ameni {{isset($shelter->amenities) && in_array('4',$shelter->amenities) ? 'd-none' : ''}}">
                          <img src="{{URL::asset('images/icon/icon-black/geyser.png')}}" draggable="false">
                        </div>
                        <div class="img-ameni-white {{isset($shelter->amenities) && in_array('4',$shelter->amenities) ? '' : 'd-none'}}">
                ...
                <ul class="chec-radio pl-0">
                  <li class="pz">
                    <label class="radio-inline">
                      ...
                      <div class="clab">
                        <div class="img-ameni {{isset($shelter->amenities) && in_array('5',$shelter->amenities) ? 'd-none' : ''}}">
                          <img src="{{URL::asset('images/icon/icon-black/ac.png')}}" draggable="false">
                        </div>
                        <div class="img-ameni-white {{isset($shelter->amenities) && in_array('5',$shelter->amenities) ? '' : 'd-none'}}">
                ...
                <ul class="chec-radio pl-0">
                  <li class="pz">
                    <label class="radio-inline">
                      ...
                      <div class="clab">
                        <div class="img-ameni {{isset($shelter->amenities) && in_array('6',$shelter->amenities) ? 'd-none' : ''}}">
                          <img src="{{URL::asset('images/icon/icon-black/tv.png')}}" draggable="false">
                        </div>
                        <div class="img-ameni-white {{isset($shelter->amenities) && in_array('6',$shelter->amenities) ? '' : 'd-none'}}">
                ...
                <ul class="chec-radio pl-0">
                  <li class="pz">
                    <label class="radio-inline">
                      ...
                      <div class="clab">
                        <div class="img-ameni {{isset($shelter->amenities) && in_array('7',$shelter->amenities) ? 'd-none' : ''}}">
                          <img src="{{URL::asset('images/icon/icon-black/wifi.png')}}" draggable="false">
                        </div>
                        <div class="img-ameni-white {{isset($shelter->amenities) && in_array('7',$shelter->amenities) ? '' : 'd-none'}}">
                ...
                <ul class="chec-radio pl-0">
                  <li class="pz">
                    <label class="radio-inline">
                      ...
                      <div class="clab">
                        <div class="img-ameni {{isset($shelter->amenities) && in_array('8',$shelter->amenities) ? 'd-none' : ''}}">
                          <img src="{{URL::asset('images/icon/icon-black/laundary.png')}}" draggable="false">
                        </div>
                        <div class="img-ameni-white {{isset($shelter->amenities) && in_array('8',$shelter->amenities) ? '' : 'd-none'}}">
                ...
                <ul class="chec-radio pl-0">
                  <li class="pz">
                    <label class="radio-inline">
                      ...
                      <div class="clab">
                        <div class="img-ameni {{isset($shelter->amenities) && in_array('9',$shelter->amenities) ? 'd-none' : ''}}">
                          <img src="{{URL::asset('images/icon/icon-black/ro-water.png')}}" draggable="false">
                        </div>
                        <div class="img-ameni-white {{isset($shelter->amenities) && in_array('9',$shelter->amenities) ? '' : 'd-none'}}">
                ...
                <ul class="chec-radio pl-0">
                  <li class="pz">
                    <label class="radio-inline">
                      ...
                      <div class="clab">
                        <div class="img-ameni {{isset($shelter->amenities) && in_array('10',$shelter->amenities) ? 'd-none' : ''}}">
                          <img src="{{URL::asset('images/icon/icon-black/parking.png')}}" draggable="false">
                        </div>
                        <div class="img-ameni-white {{isset($shelter->amenities) && in_array('10',$shelter->amenities) ? '' : 'd-none'}}">
                ...
                <ul class="chec-radio pl-0">
                  <li class="pz">
                    <label class="radio-inline">
                      ...
                      <div class="clab">
                        <div class="img-ameni {{isset($shelter->amenities) && in_array('11',$shelter->amenities) ? 'd-none' : ''}}">
                          <img src="{{URL::asset('images/icon/icon-black/cooler.png')}}" draggable="false">
                        </div>
                        <div class="img-ameni-white {{isset($shelter->amenities) && in_array('11',$shelter->amenities) ? '' : 'd-none'}}">
                ...
                <ul class="chec-radio pl-0">
                  <li class="pz">
                    <label class="radio-inline">
                      ...
                      <div class="clab">
                        <div class="img-ameni {{isset($shelter->amenities) && in_array('12',$shelter->amenities) ? 'd-none' : ''}}">
                          <img src="{{URL::asset('images/icon/icon-black/sleeping-mattress.png')}}" draggable="false">
                        </div>
                        <div class="img-ameni-white {{isset($shelter->amenities) && in_array('12',$shelter->amenities) ? '' : 'd-none'}}">
                ...
                <ul class="chec-radio pl-0">
                  <li class="pz">
                    <label class="radio-inline">
                      ...
                      <div class="clab">
                        <div class="img-ameni {{isset($shelter->amenities) && in_array('13',$shelter->amenities) ? 'd-none' : ''}}">
                          <img src="{{URL::asset('images/icon/icon-black/power.png')}}" draggable="false">
                        </div>
                        <div class="img-ameni-white {{isset($shelter->amenities) && in_array('13',$shelter->amenities) ? '' : 'd-none'}}">
                ...
                <ul class="chec-radio pl-0">
                  <li class="pz">
                    <label class="radio-inline">
                      ...
                      <div class="clab">
                        <div class="img-ameni {{isset($shelter->amenities) && in_array('14',$shelter->amenities) ? 'd-none' : ''}}">
                          <img src="{{URL::asset('images/icon/icon-black/balcony.png')}}" draggable="false">
                        </div>
                        <div class="img-ameni-white {{isset($shelter->amenities) && in_array('14',$shelter->amenities) ? '' : 'd-none'}}">
                ...
                <ul class="chec-radio pl-0">
                  <li class="pz">
                    <label class="radio-inline">
                      ...
                      <div class="clab">
                        <div class="img-ameni {{isset($shelter->rules) && in_array('1',$shelter->rules) ? 'd-none' : ''}}">
                          <img src="{{URL::asset('images/icon/icon-black/non-smoking')}}.png" draggable="false">
                        </div>
                        <div class="img-ameni-white {{isset($shelter->rules) && in_array('1',$shelter->rules) ? '' : 'd-none'}}">
                ...
                <ul class="chec-radio pl-0">
                  <li class="pz">
                    <label class="radio-inline">
                      ...
                      <div class="clab">
                        <div class="img-ameni {{isset($shelter->rules) && in_array('2',$shelter->rules) ? 'd-none' : ''}}">
                          <img src="{{URL::asset('images/icon/icon-black/gate.png')}}" draggable="false">
                        </div>
                        <div class="img-ameni-white {{isset($shelter->rules) && in_array('2',$shelter->rules) ? '' : 'd-none'}}">
                ...
                <ul class="chec-radio pl-0">
                  <li class="pz">
                    <label class="radio-inline">
                      ...
                      <div class="clab">
                        <div class="img-ameni {{isset($shelter->rules) && in_array('3',$shelter->rules) ? 'd-none' : ''}}">
                          <img src="{{URL::asset('images/icon/icon-black/guardian')}}.png" draggable="false">
                        </div>
                        <div class="img-ameni-white {{isset($shelter->rules) && in_array('3',$shelter->rules) ? '' : 'd-none'}}">
                ...
                <ul class="chec-radio pl-0">
                  <li class="pz">
                    <label class="radio-inline">
                      ...
                      <div class="clab">
                        <div class="img-ameni {{isset($shelter->rules) && in_array('4',$shelter->rules) ? 'd-none' : ''}}">
                          <img src="{{URL::asset('images/icon/icon-black/no-drinking.png')}}" draggable="false">
                        </div>
                        <div class="img-ameni-white {{isset($shelter->rules) && in_array('4',$shelter->rules) ? '' : 'd-none'}}">
                ...
                <ul class="chec-radio pl-0">
                  <li class="pz">
                    <label class="radio-inline">
                      ...
                      <div class="clab">
                        <div class="img-ameni {{isset($shelter->rules) && in_array('6',$shelter->rules) ? 'd-none' : ''}}">
                          <img src="{{URL::asset('images/icon/icon-black/non-veg')}}.png" draggable="false">
                        </div>
                        <div class="img-ameni-white {{isset($shelter->rules) && in_array('6',$shelter->rules) ? '' : 'd-none'}}">
        ...
        <section>
          <div class="inner">
            <div class="row pl-3">
              <div class="col-lg-4 mt-4">
                <div class="form-group">
                  <label for="owner_name" class="age-title font-weight-bold">Owner’s Name</label>
              ...
              <div class="col-lg-4 mt-4">
                <div class="form-group">
                  <label for="contact_no" class="age-title font-weight-bold">Contact Number</label>
            ...
            <div class="row pl-3  pt-4">
              <div class="col-lg-4 mt-4">
                <div class="form-group available_date">
                  <label for="available_date" class="age-title font-weight-bold">Availability Date &nbsp;&nbsp;<span
                      class='availability-info' data-html="true" data-toggle="tooltip" data-placement="top" title="Date from when this property is available">
                      ? </span>
                  </label>
              ...
              <div class="col-lg-8 col-md-12">
                <div class="container-fluid">
                  <label class="age-title">Featured Image</label>
                  <div class="row" id="feature_result">
              ...
              <div class="col-lg-8 col-md-12">
                <div class="container-fluid">
                  <label class="age-title">Gallery</label>
            ...
            <div class="row pl-lg-3 pl-md-0">
              <div class="col-lg-12 mt-4">
                <div class="form-group">
                  <a href="{{url('edit-shelter')}}/{{$shelter->id}}/{{$shelter->user_id}}" class="top-listing-btn preview px-5" id="editShelter" style="color:#fff;">
                    Edit Shelter
                  </a>
                  <a class="top-listing-btn preview px-5 ml-lg-3 ml-md-3 publishUnpublish" id="previewPublish" data-shelter="{{$shelter->id}}" data-user="{{$shelter->user_id}}" data-publish="0" style="color:#fff;" >
                    Save & Publish
                  </a>
                  <a href="{{url('/')}}" class="top-listing-btn preview px-5 ml-lg-3 ml-md-3"  style="color:#fff;" >
                    Save & Exit
                  </a>
                </div>
              </div>
